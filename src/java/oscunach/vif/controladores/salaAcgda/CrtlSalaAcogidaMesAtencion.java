    ...
    private CartesianChartModel diasAtencionGenero(int anio) {
        ...
        try {
            ...
            for (int i = 0; i < lst.size(); i++) {
                ...
                femeninoTotal= femeninoTotal+FBSalaAcgda.obtenerDatosDadoMesAtencionGenero(anio, lst.get(i), "F").size();
            }
            ...
            for (int i = 0; i < lst.size(); i++) {
                ...
                masculinoTotal = masculinoTotal + FBSalaAcgda.obtenerDatosDadoMesAtencionGenero(anio, lst.get(i), "M").size();
            }
