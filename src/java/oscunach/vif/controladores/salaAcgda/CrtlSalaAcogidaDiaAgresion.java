...
public class CrtlSalaAcogidaDiaAgresion {
    ...
    private CartesianChartModel diasAtencion(int anio) {
        ...
        try {
            ...
            dias.setLabel("Dias de Agresión");
    ...
    private CartesianChartModel diasAtencionGenero(int anio) {
        ...
        try {
            ...
            for (int i = 0; i < lst.size(); i++) {
                ...
                femeninoTotal = femeninoTotal + FBSalaAcgda.obtenerDatosDadoDiaAgresionGenero(anio, lst.get(i), "F").size();
            }
            ...
            for (int i = 0; i < lst.size(); i++) {
                ...
                masculinoTotal = masculinoTotal + FBSalaAcgda.obtenerDatosDadoDiaAgresionGenero(anio, lst.get(i), "M").size();
            }
