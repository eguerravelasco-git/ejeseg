        ...
        try {
            while (rs.next()) {
                unidadesfamilia = new UnidadesFamilia(
                        rs.getInt(" numero_causa"),
                        rs.getDate(" fecha_denuncia"),
                        rs.getString(" sexo_agresor"),
                        rs.getString(" sexo_victima"),
                        rs.getString(" barrio_agresor"),
                        rs.getString(" barrio_agredida"),
                        rs.getString(" edad_agresor"),
                        rs.getString(" edad_victima"),
                        rs.getString(" instruccion_agresor"),
                        rs.getString(" instrucc_victima"),
                        rs.getString(" parentesco"),
                        rs.getDouble(" numero_hijos"),
                        rs.getString(" lugar_agrecion"),
                        rs.getDouble(" x"),
                        rs.getDouble(" y"),
                        rs.getString(" subcircuit"),
                        rs.getString(" circuito"),
                        rs.getString(" tipo_violencia"),
                        rs.getString(" fecha_agresion"),
                        rs.getString(" medidas_amparo"),
                        rs.getString(" sentencia"),
                        rs.getString(" apelacion"),
                        rs.getString(" boletas_anteriores"),
                        rs.getString(" boletas_remision"),
                        rs.getString(" observacio"),
                        rs.getInt(" pk")
                );
